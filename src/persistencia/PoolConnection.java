...
public class PoolConnection {
	...
	private Connection connect() {
		try {
			...
			String dbConnectString = jdbc + servidor + ";databaseName=" + db
	...
	public void getConfiguration() {
		String configuracion = ".\\src\\lib\\ConfigBD.txt";
	...
	public Connection getConnection() {
		...
		if (connections.size() > 0)
			...
			c = connect();
			System.out
					.println("Se ha creado una nueva conexion fuera de los parametros de configuracion");
		}
		return c;
	}
